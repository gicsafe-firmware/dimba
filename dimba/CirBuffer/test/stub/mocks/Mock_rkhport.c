...
static struct Mock_rkhportInstance
{
  ...
  const char* rkh_get_port_version_FinalReturn;
  ...
  const char* rkh_get_port_desc_FinalReturn;
...
const char* rkh_get_port_version(void)
{
  ...
  if (Mock.rkh_get_port_version_IgnoreBool)
  {
    ...
    if (cmock_call_instance == NULL)
      return Mock.rkh_get_port_version_FinalReturn;
    Mock.rkh_get_port_version_FinalReturn = cmock_call_instance->ReturnVal;
  ...
  if (Mock.rkh_get_port_version_CallbackFunctionPointer != NULL)
  {
    cmock_call_instance->ReturnVal = Mock.rkh_get_port_version_CallbackFunctionPointer(Mock.rkh_get_port_version_CallbackCalls++);
  }
  UNITY_CLR_DETAILS();
  return cmock_call_instance->ReturnVal;
}

void rkh_get_port_version_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, const char* cmock_to_return)
{
...
void rkh_get_port_version_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, const char* cmock_to_return)
{
  CMOCK_MEM_INDEX_TYPE cmock_guts_index = CMock_Guts_MemNew(sizeof(CMOCK_rkh_get_port_version_CALL_INSTANCE));
  CMOCK_rkh_get_port_version_CALL_INSTANCE* cmock_call_instance = (CMOCK_rkh_get_port_version_CALL_INSTANCE*)CMock_Guts_GetAddressFor(cmock_guts_index);
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringOutOfMemory);
...
const char* rkh_get_port_desc(void)
{
  ...
  if (Mock.rkh_get_port_desc_IgnoreBool)
  {
    UNITY_CLR_DETAILS();
    if (cmock_call_instance == NULL)
      return Mock.rkh_get_port_desc_FinalReturn;
    Mock.rkh_get_port_desc_FinalReturn = cmock_call_instance->ReturnVal;
    return cmock_call_instance->ReturnVal;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  cmock_line = cmock_call_instance->LineNumber;
  ...
  if (Mock.rkh_get_port_desc_CallbackFunctionPointer != NULL)
  {
    cmock_call_instance->ReturnVal = Mock.rkh_get_port_desc_CallbackFunctionPointer(Mock.rkh_get_port_desc_CallbackCalls++);
  }
  UNITY_CLR_DETAILS();
  return cmock_call_instance->ReturnVal;
}

void rkh_get_port_desc_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, const char* cmock_to_return)
{
...
void rkh_get_port_desc_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, const char* cmock_to_return)
{
  CMOCK_MEM_INDEX_TYPE cmock_guts_index = CMock_Guts_MemNew(sizeof(CMOCK_rkh_get_port_desc_CALL_INSTANCE));
  CMOCK_rkh_get_port_desc_CALL_INSTANCE* cmock_call_instance = (CMOCK_rkh_get_port_desc_CALL_INSTANCE*)CMock_Guts_GetAddressFor(cmock_guts_index);
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringOutOfMemory);
